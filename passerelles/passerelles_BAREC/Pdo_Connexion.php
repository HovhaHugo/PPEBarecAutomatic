...
class Pdo_Connexion {
    ...
    private static $strBdd = 'dbname=base_msl';
    ...
    private function __construct() {
        try {
            Pdo_Connexion::$objPdo = new PDO(Pdo_Connexion::$strServeur .';' . Pdo_Connexion::$strBdd,
                    Pdo_Connexion::$strUser, Pdo_Connexion::$strMdp);
